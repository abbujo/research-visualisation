query1 =(parent)=>'{ Subject(filter: { _id:"' + parent + '"}){ _id Reduce { _id _type label } Reduce { _id _type label } BeGoodVaccination { _id _type label } SocialControl { _id _type label } Control { _id _type label } PregnantBe { _id _type label } Nominate { _id _type label } Meet { _id _type label } ApplyShare { _id _type label } Minimize { _id _type label } Protect { _id _type label } Reduce { _id _type label } Reduce { _id _type label } FollowCovid { _id _type label } PayLess { _id _type label } Wear { _id _type label } Give { _id _type label } Carry { _id _type label } WearPrivate { _id _type label } Test { _id _type label } IndoorAvoidBy { _id _type label } ResumeNormal { _id _type label } Visit { _id _type label } SpreadByInfected { _id _type label } AvoidClose { _id _type label } Wash { _id _type label } Isolate { _id _type label } Be { _id _type label } Persist { _id _type label } Wash { _id _type label } Isolate { _id _type label } AvoidClose { _id _type label } Do { _id _type label } Avoid { _id _type label } CloseLeave { _id _type label } Continue { _id _type label } PrimaryCloseIsolate { _id _type label } Cause { _id _type label } RegularBe { _id _type label } Consult { _id _type label } }}'
query2 = (topic) => '{ _CONTEXT { _id _type Subject label } Subject(filter:{_id: ["' + topic.map(function (item) { return '"' + item + '"' }) +']}){ _id _type label Reduce { _id } Reduce { _id } BeGoodVaccination { _id } SocialControl { _id } Control { _id } PregnantBe { _id } Nominate { _id } Meet { _id } ApplyShare { _id } Minimize { _id } Protect { _id } Reduce { _id } Reduce { _id } FollowCovid { _id } PayLess { _id } Wear { _id } Give { _id } Carry { _id } WearPrivate { _id } Test { _id } IndoorAvoidBy { _id } ResumeNormal { _id } Visit { _id } SpreadByInfected { _id } AvoidClose { _id } Wash { _id } Isolate { _id } Be { _id } Persist { _id } Wash { _id } Isolate { _id } AvoidClose { _id } Do { _id } Avoid { _id } CloseLeave { _id } Continue { _id } PrimaryCloseIsolate { _id } Cause { _id } RegularBe { _id } Consult { _id } }}'
var apiUri = ""
